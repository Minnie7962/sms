<div class="card">
    ...
    <div class="card-body">
        ...
        <form wire:submit.prevent="loadStudents" class="md:grid grid-cols-4 gap-2">
            ...
            <x-button label="Fetch students" class="w-full" icon="fas fa-key" type="submit" style="font-size: 1.2em; padding: 10px 20px;"/>
        </form>
        <x-loading-spinner />
                                    ...
                                    <tr>
                                        ...
                                        <td class="border p-2">
                                            <x-select name="student_id[]" id="student-{{ $student->id }}" class="promote">
                                                <option value="{{ $student->id }}" {{ $student->promoted ? 'selected' : '' }}>Promote</option>
